...
def retrieve_senate_debates(start_year, end_year, save_root):
    prefix = 'https://www.openaustralia.org.au'

    for year in range(start_year, end_year+1):
        print(f"Searching for dates in year {year}")
        year_url = 'https://www.openaustralia.org.au/senate/?y=' + str(year)
        ...
        for date_url in date_urls:
            ...
            post_pattern = re.compile(
                r'/senate/\?id=[0-9]{4}-[0-9]{2}-[0-9]{2}\.[0-9]+\.[0-9]+')
...
if __name__ == '__main__':
    ...
    start_year = 2006
    end_year = 2024
    save_root = '/Users/yifan/Documents/GitHub/datasets/Gale-Literature-Criticism/senate_debates'
    retrieve_senate_debates(start_year, end_year, save_root)
